...
$query = mysqli_query($koneksi,"SELECT * FROM tb_ep WHERE id_ep='$id'");
...
<form action="pro_ep.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-4">
        ...
        <input type="hidden" class="form-control" name="nama" id="floatingInputGrid" placeholder="Nama EP" value="<?=($data['id_ep'])?>" required>
        <input type="text" class="form-control" name="nama" id="floatingInputGrid" placeholder="Nama EP" value="<?=($data['epname'])?>" required>
        <label for="floatingInputGrid">Nama EP</label>
    </div>
    </div>
    <div class="col-md-4">
        <div class="form-floating">
        <input type="text" class="form-control" name="nmunik" id="floatingInputGrid" placeholder="Poin"  value="<?=($data['nmunik'])?>" required>
